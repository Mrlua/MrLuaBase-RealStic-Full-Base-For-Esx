...
RegisterNetEvent('MrLua_BaseCore:client:alcotester')
AddEventHandler('MrLua_BaseCore:client:alcotester', function()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
		...
		local player =	GetPlayerServerId(data.current.player)
			TriggerServerEvent('MrLua_BaseCore:server:AlcoTest', GetPlayerServerId(PlayerId()), player)
			menu.close()
...
RegisterNetEvent('MrLua_BaseCore:client:ShowAlco')
AddEventHandler('MrLua_BaseCore:client:ShowAlco', function()
...
AddEventHandler('MrLua_BaseCore:client:resetStatus', function()
...
AddEventHandler('playerSpawned', function(spawn)
	if Config.Status then
	if IsDead then
		TriggerEvent('MrLua_BaseCore:client:resetStatus')
	end
...
RegisterNetEvent('MrLua_BaseCore:client:StartEat')
AddEventHandler('MrLua_BaseCore:client:StartEat', function(item, label, g, prop, hunger, p1 , p2 , p3, p4 , p5 , p6)
			if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				...
				while true do
					...
					if IsEntityDead(player) then
						...
						FoodEat = false
						TriggerServerEvent('MrLua_BaseCore:server:RemoveItem', item)
						break
					end
						...
						if g > 100 then
							...
							if Config.Status then
								TriggerServerEvent('MrLua_BaseCore:client:UpdateStatus', 'hunger', hunger)
							end
						elseif g < 100 then
						...
						if IsControlJustPressed(0, Config.FoodThrow) then
							...
							if IsControlJustPressed(0, Config.ServeFood) then
								...
								ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
									...
									local player =	GetPlayerServerId(data.current.player)
										TriggerServerEvent('MrLua_BaseCore:server:RemoveItem', item)
										TriggerServerEvent('MrLua_BaseCore:server:ReceiverFood', GetPlayerServerId(PlayerId()), player, item, label, g, prop, hunger, p1 , p2 , p3, p4 , p5 , p6)
										menu.close()
										FoodEat = false
										ClearPedTasks(player)
										DetachEntity(propfood, 1, 1)
...
RegisterNetEvent('MrLua_BaseCore:client:StartReceiverEat')
AddEventHandler('MrLua_BaseCore:client:StartReceiverEat', function(item, label, g, prop, hunger, p1 , p2 , p3, p4 , p5 , p6)
			if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				TriggerServerEvent('MrLua_BaseCore:server:AddItem', item)
				FoodEat = true
				local player = PlayerPedId()
				local x,y,z = table.unpack(GetEntityCoords(player))
				propfood = CreateObject(GetHashKey(prop), x, y, z+0.2,  true,  true, true)
...
RegisterNetEvent('MrLua_BaseCore:client:StartDrink')
AddEventHandler('MrLua_BaseCore:client:StartDrink', function(item, item2, ml, propd, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
			if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				if split then
					TriggerEvent('MrLua_BaseCore:client:StartSplitDrink', item, item2, ml, propd, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
				else
				Drink = true
				...
				while true do
					...
					if Drink then 
						...
						if ml > 100 then
							...
							ClearPedTasks(player)
							if Config.Status then
								TriggerServerEvent('MrLua_BaseCore:client:UpdateStatus', 'thirst', drinkstatus)
							end
						...
						if IsControlJustPressed(0, Config.DrinkThrowButton) then
							...
							if IsControlJustPressed(0, Config.ServeDrink) then
								...
								ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
									...
									local player =	GetPlayerServerId(data.current.player)
										TriggerServerEvent('MrLua_BaseCore:server:RemoveItem', item)
										TriggerServerEvent('MrLua_BaseCore:server:ReceiverDrink', GetPlayerServerId(PlayerId()), player, item, item2, ml, propdrink, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
										menu.close()
										Drink = false
...
RegisterNetEvent('MrLua_BaseCore:client:StartReceiverDrink')
AddEventHandler('MrLua_BaseCore:client:StartReceiverDrink', function(item, item2, ml, propdrink, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
			if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				if split then
					TriggerEvent('MrLua_BaseCore:client:StartSplitDrink', item, item2, ml, propdrink, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
				else
				TriggerServerEvent('MrLua_BaseCore:server:AddItem', item)
				Drink = true
				local ad = "amb@code_human_wander_drinking_fat@beer@male@base"
							...
							if IsControlJustPressed(0, Config.ServeDrink) then
								...
								ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
									...
									local player =	GetPlayerServerId(data.current.player)
										...
										TriggerServerEvent('MrLua_BaseCore:server:RemoveItem', item)
										TriggerServerEvent('MrLua_BaseCore:server:ReceiverDrink', GetPlayerServerId(PlayerId()), player, item, item2, ml, propd, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
										menu.close()
										DetachEntity(propdrink, 1, 1)
										DeleteObject(propdrink)
										ClearPedTasks(playerPed)
...
RegisterNetEvent('MrLua_BaseCore:client:StartSplitDrink')
AddEventHandler('MrLua_BaseCore:client:StartSplitDrink', function(item, item2, ml, propd, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
			if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				SplitDrink = true
					...
					if SplitDrink then 
						...
						if IsControlJustPressed(0, Config.DrinkThrowButton) then
							...
							if IsControlJustPressed(0, Config.SplitDrinkButton) then
								...
								TriggerEvent('MrLua_BaseCore:client:ShotDrinkSplit', item, item2, ml, propdrink, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
								else
...
--------------------Shot Drink-----------------
RegisterNetEvent('MrLua_BaseCore:client:ShotDrinkSplit')
AddEventHandler('MrLua_BaseCore:client:ShotDrinkSplit', function(item, item2, ml, propdrink, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
			if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				mlshot = 30
				...
				while true do
					...
					elseif IsControlJustPressed(0, Config.DrinkThrowButton) then
						...
						if mlshot < 29 then
							...
							DetachEntity(propsplitdrink, 1, 1)
							DeleteObject(propsplitdrink)
							TriggerServerEvent('MrLua_BaseCore:server:AddItem', item2)
							DrinkShot = false
							SplitDrink = true
							AttachEntityToEntity(propdrink, player, GetPedBoneIndex(player, 28422), p1 ,p2 , p3, p4 , p5 , p6, true, true, false, true, 1, true)
							break
					...
					elseif IsControlJustPressed(0, Config.ServeDrink) then
								...
								ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
									...
									local player =	GetPlayerServerId(data.current.player)
										TriggerServerEvent('MrLua_BaseCore:server:ReceiverDrinkShot', GetPlayerServerId(PlayerId()), player, item, item2, mlshot, alcohol, drinkstatus)
										menu.close()
										DrinkShot = false
										ClearPedTasks(playerPed)
										DetachEntity(propsplitdrink, 1, 1)
...
RegisterNetEvent('MrLua_BaseCore:client:ReceiverDrinkShot')
AddEventHandler('MrLua_BaseCore:client:ReceiverDrinkShot', function(item, item2, mlshot, alcohol, drinkstatus)
			if  Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				DrinkShot = true
				...
				while true do
					...
					elseif IsControlJustPressed(0, Config.ServeDrink) then
								...
								ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
									...
									local player =	GetPlayerServerId(data.current.player)
										TriggerServerEvent('MrLua_BaseCore:server:ReceiverDrinkShot', GetPlayerServerId(PlayerId()), player, item2, label, mlshot, alcohol, drinkstatus)
										menu.close()
										DrinkShot = false
										ClearPedTasks(playerPed)
										DetachEntity(propsplitdrink, 1, 1)
...
RegisterNetEvent('MrLua_BaseCore:client:DrinkShot')
AddEventHandler('MrLua_BaseCore:client:DrinkShot', function(item, label, mlshot, alcohol, drinkstatus)
			if  Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				mlshot = 30
				...
				while true do
					...
					elseif IsControlJustPressed(0, Config.ServeDrink) then
								...
								ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
									...
									local player =	GetPlayerServerId(data.current.player)
										TriggerServerEvent('MrLua_BaseCore:server:ReceiverDrinkShot', GetPlayerServerId(PlayerId()), player, item, label, mlshot, alcohol, drinkstatus)
										menu.close()
										DrinkShot = false
										ClearPedTasks(playerPed)
										DetachEntity(propsplitdrink, 1, 1)
...
RegisterNetEvent('MrLua_BaseCore:client:StartDrinkWine')
AddEventHandler('MrLua_BaseCore:client:StartDrinkWine', function(item, item2, ml, propw, alcohol, drinkstatus, p1, p2, p3, p4, p5, p6)
			if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				DrinkWine = true
					...
					if DrinkWine then 
						...
						if IsControlJustPressed(0, Config.DrinkThrowButton) then
							...
							if IsControlJustPressed(0, Config.SplitDrinkButton) then
								...
								TriggerEvent('MrLua_BaseCore:client:WineDrinkGlass', item, item2, propw, ml, alcohol, drinkstatus, p1 , p2, p3, p4, p5, p6)
								else
									exports['mythic_notify']:DoHudText('error', _U('alreadybottle'))
								end
							end
							if IsControlJustPressed(0, Config.ServeDrink) then
								...
								ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
									...
									local player =	GetPlayerServerId(data.current.player)
										TriggerServerEvent('MrLua_BaseCore:server:RemoveItem', item)
										TriggerServerEvent('MrLua_BaseCore:server:ReceiverDrinkSplitWine', GetPlayerServerId(PlayerId()), player, item, item2, ml, propw, alcohol, drinkstatus, p1, p2, p3, p4, p5, p6)
										menu.close()
										DrinkWine = false
										ClearPedTasks(playerPed)
										DetachEntity(propwine, 1, 1)
...
RegisterNetEvent('MrLua_BaseCore:client:ReceiverDrinkSplitWine')
AddEventHandler('MrLua_BaseCore:client:ReceiverDrinkSplitWine', function(item, item2, ml, propw, alcohol, drinkstatus, p1, p2, p3, p4, p5, p6)
			if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				TriggerServerEvent('MrLua_BaseCore:server:AddItem', item)
...
RegisterNetEvent('MrLua_BaseCore:client:ReceiverDrinkGlass')
AddEventHandler('MrLua_BaseCore:client:ReceiverDrinkGlass', function(item, label, mlwine, alcohol, drinkstatus, p1, p2, p3, p4, p5, p6)
			if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				...
				while true do
					...
					elseif IsControlJustPressed(0, Config.ServeDrink) then
								...
								ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
									...
									local player =	GetPlayerServerId(data.current.player)
										TriggerServerEvent('MrLua_BaseCore:server:ReceiverDrinkGlass', GetPlayerServerId(PlayerId()), player, item, label, mlwine, alcohol, drinkstatus, p1, p2, p3, p4, p5, p6)
										menu.close()
										DrinkGlass = false
										DetachEntity(propwineglass, 1, 1)
										DeleteObject(propwineglass)
...
-----------wine glass---------------
RegisterNetEvent('MrLua_BaseCore:client:WineDrinkGlass')
AddEventHandler('MrLua_BaseCore:client:WineDrinkGlass', function(item, item2, propw, ml, alcohol, drinkstatus, p1, p2, p3, p4, p5, p6)
			if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				mlwine = 100
				...
				while true do
					...
					elseif IsControlJustPressed(0, Config.ServeDrink) then
								...
								ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
									...
									local player =	GetPlayerServerId(data.current.player)
										TriggerServerEvent('MrLua_BaseCore:server:ReceiverDrinkGlass', GetPlayerServerId(PlayerId()), player, item, item2, mlwine, alcohol, drinkstatus, p1, p2, p3, p4, p5, p6)
										DrinkGlass = false
										menu.close()
										ClearPedTasks(playerPed)
										DetachEntity(propwineglass, 1, 1)
...
RegisterNetEvent('MrLua_BaseCore:client:WineGlass')
AddEventHandler('MrLua_BaseCore:client:WineGlass', function(item, label, mlwine, alcohol, drinkstatus)
			if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then 
				exports['mythic_notify']:DoHudText('error', _U('already'))
			else
				DrinkGlass = true
				...
				while true do
					...
					elseif IsControlJustPressed(0, Config.ServeDrink) then
								...
								ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
									...
									local player =	GetPlayerServerId(data.current.player)
									TriggerServerEvent('MrLua_BaseCore:server:RemoveItem', item)
										TriggerServerEvent('MrLua_BaseCore:server:ReceiverDrinkGlass', GetPlayerServerId(PlayerId()), player, item, label, mlwine, alcohol, drinkstatus)
										menu.close()
										DrinkGlass = false
										ClearPedTasks(playerPed)
										DetachEntity(propwineglass, 1, 1)
